...
raspi-config nonint do_ssh 1                  # Enable remote ssh login
...
raspi-config nonint do_wifi_country DE                           # Set wifi country as Australia
#do_wifi_ssid_passphrase wifi_name password   # Set wlan0 network to join 'wifi_name' network using 'password'
raspi-config nonint do_change_timezone Europe/Berlin                    # Change timezone to Europe
raspi-config nonint do_change_locale de_DE.UTF-8                 # Set language to German German
